<template>
  <div class="var-dynamic__lockerForm" style="padding: 0;">
    <div style="padding: 10px 10px 0;">
      ...
      <div class="var-dynamic__lockerForm--box">
        <div class="var-dynamic__lockerForm--title">线条方向</div>
        <div class="var-dynamic__lockerForm--body">
          <button-group v-model="value['direction']" :data="['horizontal', 'vertical']" @change="v => onUpdate('direction', v)"/>
        </div>
      </div>
      <div class="var-dynamic__lockerForm--box">
        <div class="var-dynamic__lockerForm--title">内容位置</div>
        <div class="var-dynamic__lockerForm--body">
          <button-group v-model="value['contentPosition']" :data="['left', 'center', 'right']" @change="v => onUpdate('contentPosition', v)"/>
        </div>
      </div>
      <alert type="warning" show-icon :closable="false" style="padding: 2px 10px; margin: 5px 0;" title="会继承父级的样式"/>
      <div class="var-dynamic__lockerForm--box">
        <div class="var-dynamic__lockerForm--title">字体粗细</div>
        <div class="var-dynamic__lockerForm--body">
      ...
      <div class="var-dynamic__lockerForm--box">
        <div class="var-dynamic__lockerForm--title">字体行高</div>
        <div class="var-dynamic__lockerForm--body">
      ...
      <div class="var-dynamic__lockerForm--box">
        <div class="var-dynamic__lockerForm--title">字体大小</div>
        <div class="var-dynamic__lockerForm--body">
...
export default {
  ...
  methods: {
    defaultValue () {
      ...
      if (!data['contentPosition']) data['contentPosition'] = 'center';
      if (!data['direction']) data['direction'] = 'horizontal';
